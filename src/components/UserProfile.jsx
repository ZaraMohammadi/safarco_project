...
const UserProfile = ()=>{
  ...
  const fetchData = async (token) => {
    try {
      const response = await axios.get('https://safarcoo.liara.run/api/userinfo', {
        headers: {
    ...
    useEffect(() => {
      ...
      const updateData = async (token) => {
        try {
          const response = await axios.post('https://safarcoo.liara.run/api/edit-profile', 
          { 
    ...
    return(<>
            ...
            <div className="col-start-1 sm:col-start-3 sm:col-end-13 col-end-7 sm:bg-accent-200 bg-white p-8 px-10 rounded-lg mb-20">
